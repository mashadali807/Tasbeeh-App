...
class DailyAdhkarDetailScreen extends StatelessWidget {
  const DailyAdhkarDetailScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final adhkar = _parseArguments();
                    ...
                    child: Row(
                      children: [
                        ...
                        IconButton(
                          ...
                          onPressed: () => controller.toggleFavorite(adhkar.id),
                          tooltip: isFav
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          ElevatedButton.icon(
                            onPressed: () => controller.startDhikr(adhkar),
  ...
  // Helper to safely parse Get.arguments
  DailyAdhkar _parseArguments() {
    final args = Get.arguments;
    if (args is DailyAdhkar) {
      return args;
    } else if (args is Map<String, dynamic>) {
      return DailyAdhkar.fromJson(args);
    } else {
